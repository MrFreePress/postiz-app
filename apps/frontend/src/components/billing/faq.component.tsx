  ...
  return [
      ...
      ? [
          {
            ...
            description: t(
              ...
              'To confirm credit card information, the platform may place a temporary $2 hold and release it immediately. You can cancel your subscription anytime from settings without talking to a person.'
            ),
          },
        ]
      : []),
    {
      ...
      description: t(
        ...
        'This platform is built on open-source foundations and is being operated as a controlled pilot with deliberate onboarding and transparent workflows.'
      ),
    },
    {
      ...
      description: t(
        ...
        `This platform allows you to schedule your posts between different channels.
